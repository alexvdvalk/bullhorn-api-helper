...
export const getBHToken = async (username: string, password: string, clientId: string, clientSecret: string, cluster: string = "emea", ttl = 2880) => {
    ...
    try {
        ...
        throw new Error("Failed to get BH Token, check credentials and try browsing to: https://auth-emea9.bullhornstaffing.com/oauth/authorize?client_id=82bcb8dd-7137-46aa-9515-63ce0ca20d58&response_type=code&username=[username]&password=[password]&action=Login and accept the terms and condition");
    }
}
